...
exports.testTypedSignature = void 0;
var ethereum_provider_1 = require("@rarible/ethereum-provider");
function testTypedSignature(eth) {
    return __awaiter(this, void 0, void 0, function () {
        var domain, types, message, data, signature;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, ethereum_provider_1.signTypedData(eth, data)];
                case 1:
                    signature = _a.sent();
...
exports.testTypedSignature = testTypedSignature;
