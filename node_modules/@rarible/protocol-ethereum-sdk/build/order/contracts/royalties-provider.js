...
exports.testRoyaltiesProviderBytecode = exports.deployRoyaltiesProvider = exports.createRoyaltiesProviderContract = void 0;
function createRoyaltiesProviderContract(web3, address) {
    return new web3.eth.Contract(testRoyaltiesProviderAbi, address);
}
exports.createRoyaltiesProviderContract = createRoyaltiesProviderContract;
function deployRoyaltiesProvider(web3, name, symbol) {
    return __awaiter(this, void 0, void 0, function () {
        var empty, address;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    empty = createRoyaltiesProviderContract(web3);
                    return [4 /*yield*/, web3.eth.getAccounts()];
                case 1:
                    address = (_a.sent())[0];
                    return [2 /*return*/, empty
                            .deploy({ data: exports.testRoyaltiesProviderBytecode, arguments: [name, symbol] })
                            .send({ from: address, gas: 3000000, gasPrice: "0" })];
            }
        });
    });
}
exports.deployRoyaltiesProvider = deployRoyaltiesProvider;
